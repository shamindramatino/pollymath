  ...
  "inline-flex items-center justify-center rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        ghost: "hover:text-accent-foreground hover:bg-accent",//hover:bg-accent
        link: "text-primary underline-offset-4 hover:underline",
      },
      size: {
        default: "h-9 px-4 py-4",
        sm: "h-8 rounded-md px-2 py-5 text-xs",
        lg: "h-10 rounded-md px-8",
        icon: "h-8 w-8",
        small: "h-8 rounded-md px-2 w-28 shadow-sm text-xs",
        add: "h-8 rounded-md px-2 w-20  text-xs text-primary-foreground bg-primary"
      },
    },
    defaultVariants: {
      variant: "default",
